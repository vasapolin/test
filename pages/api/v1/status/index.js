...
async function status(request, response) {
  ...
  try {
    ...
    try {
      ...
      console.log(
        "API Status: Versión de base de datos obtenida:",
    ...
    try {
      ...
      console.log(
        "API Status: Conexiones máximas obtenidas:",
        databaseMaxConnectionsValue,
      );
    } catch (error) {
    ...
    const databaseName =
      process.env.POSTGRES_DATABASE || process.env.DB_NAME || "neondb";
    ...
    try {
      ...
      console.log(
        "API Status: Conexiones abiertas:",
        databaseOpenedConnectionsValue,
      );
    } catch (error) {
